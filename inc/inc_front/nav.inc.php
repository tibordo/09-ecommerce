                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample07">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <!-- accès aux internautes authentifiés sur le site -->
                            <?php if(connect()): ?>
                            ...
                            <?php else: ?>
                                ...
                                <!-- accès aux visiteurs lambda, non authentifiés sur le site -->
                                <li class="nav-item">
                        ...
                        <!-- Exo : afficher dans la nav la phrase "Hello ! nom prenom" en passant par le fichier de session de l'utilisateur ($_SESSION) -->    
                        <?php
                            // Si l'indice 'user' est défini, cela veut dire que l'internaute est passé par la page connexion et est authentifié sur le site, alors on entre dans le IF
                            
                            // if(isset($_SESSION['user']))
                            // {
                            //     echo "<span class='fst-italic text-white'><a href='profil.php' class='text-white link-profil' title='Accès à votre compte'>Hello " . $_SESSION['user']['prenom'] . ' ' . $_SESSION['user']['nom'] . " !</a></span>";
