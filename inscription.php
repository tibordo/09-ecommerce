...
if(isset($_POST['civilite'], $_POST['pseudo'], $_POST['password'], $_POST['confirm_password'], $_POST['email'], $_POST['prenom'], $_POST['nom'], $_POST['adresse'], $_POST['ville'], $_POST['code_postal']))
{
    ...
    // Si l'indice name 'pdc' n'est pas défini, cela veut dire que l'internaute n'a pas coché la case des politiques de confidentialité
    if(!isset($_POST['pdc']))
    {
    ...
    if(!isset($error))
    {
        ...
        // On ne conserve jamais le mot de passe en 'clair' dans la BDD, pour cela nous devons créer une clé de hachage du mot de passe en BDD
        // arguments :
        ...
        // On stocke un message de validation dans le fichier session de l'utiisateur
        ...
        // On redirige l'internaute vers la page connexion.php après l'execution de la requete d'insertionn après l'inscription de l'internaute
...
?>
    ...
    <?php
    if(isset($errorPdc)) echo $errorPdc;
    ?>
