...
if(isset($_POST['reference'], $_POST['categorie'], $_POST['titre'], $_POST['description'], $_POST['couleur'], $_POST['taille'], $_POST['public'], $_POST['prix'], $_POST['stock']))
{
    ...
    if(!empty($_FILES['photo']['name']))
    {
        ...
        // ex: http://localhost/PHP-wf-1098/09-ecommerce/asset/uploads/15A89-tee-shirt1.jpg
        ...
        echo "<p style='margin-left: 250 px'>$photoDossier</p><hr>";
    ...
    $ajoutProduit = $bdd->prepare("INSERT INTO produit (reference, categorie, titre, description, couleur, taille, photo, public, prix, stock) VALUES (:reference,:categorie, :titre, :description, :couleur, :taille, :photo, :public, :prix, :stock)");

        $ajoutProduit->bindValue(':reference', $_POST['reference'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':categorie', $_POST['categorie'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':titre', $_POST['titre'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':description', $_POST['description'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':couleur', $_POST['couleur'], PDO::PARAM_STR );$ajoutProduit->bindValue(':taille', $_POST['taille'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':public', $_POST['public'], PDO::PARAM_STR );
        $ajoutProduit->bindValue(':photo', $photoBdd);
        ...
        $validInsert = "<p class='col-6 bg-success text-white text-center mx-auto p-3 mt-3'>Le produit référence <strong>$_POST[reference]</strong> a été enregistré avec succès.</p>";
...
<form method="post" enctype="multipart/form-data" class="row g-3">
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-dark mn-5">Ajout Produit</button>
    </div>
